...
- [Team attention items](cuekit-team-attention-items-design.md) is the implemented guidance-first summary layer: a derived important-event view over `task_events` for `get_team_status`, `wait_team`, and `get_team_result`.
